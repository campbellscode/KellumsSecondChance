    ...
    ILogger<EstimateRequestService> logger) : IEstimateRequestService
{
        ...
        CancellationToken ct = default)
    {
        ...
        var entity = new EstimateRequest
        {
            ...
            LandingPage = Normalise(dto.LandingPage), ReferrerUrl = Normalise(dto.ReferrerUrl),
            UtmSource = Normalise(dto.UtmSource), UtmMedium = Normalise(dto.UtmMedium),
            UtmCampaign = Normalise(dto.UtmCampaign), UtmTerm = Normalise(dto.UtmTerm), UtmContent = Normalise(dto.UtmContent),
